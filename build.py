...
UNITS = [
    ...
    },
    {
        'id':         'hermes-desktop',
        'folder':     'md',
        'file':       '02b_hermes_desktop.md',
        'title':      'Hermes Desktop GUI 一鍵安裝（新手首選）',
        'shortTitle': '🖥️ Desktop GUI（新手首選）',
        'parent':     None,
        'isGroup':    False,
    },
    {
        ...
        'folder':     'md',
        'file':       '16_openclaw_migration.md',
        'title':      '從 OpenClaw 無痛轉移到 Hermes',
        'shortTitle': '🔄 從 OpenClaw 轉移',
        'parent':     None,
        'isGroup':    False,
    },
    {
    ...
    {
        'id':         'manual-step4c-realworld',
        'folder':     'md',
        'file':       'manual_04c_LINE_ngrok_實戰紀錄.md',
        'title':      '🎯 完整實戰紀錄：LINE × ngrok 串接全流程（含 7 個踩坑）',
        'shortTitle': '🎯 完整實戰紀錄',
        'parent':     'manual-group',
        'isGroup':    False,
    },
    ...
    },
    {
        ...
        'folder':     'md',
        'file':       '06_telegram.md',
        'title':      'Telegram 機器人完整設定',
        'shortTitle': '✈️ Telegram',
    ...
    },
    {
        'id':         'line-official',
        'folder':     'md',
        'file':       '07a_line_official.md',
        'title':      'LINE 官方原生方案（推薦）',
        'shortTitle': '💚 LINE 官方原生',
        'parent':     'platform-group',
        'isGroup':    False,
    },
    {
        ...
        'folder':     'md',
        'file':       '07_line.md',
        'title':      'LINE Bridge 方案（進階）',
        'shortTitle': '💚 LINE Bridge 進階',
        'parent':     'platform-group',
        'isGroup':    False,
    },
    {
        ...
        'folder':     'md',
        'file':       '04c_cloudflare_tunnel.md',
        'title':      'Cloudflare Tunnel 完整教學',
        'shortTitle': '🌩️ Cloudflare Tunnel',
        'parent':     'platform-group',
        'isGroup':    False,
    },
    {
    ...
    },
    {
        'id':         'claude-cowork-3p',
        'folder':     'md',
        'file':       '15_claude_cowork_3p.md',
        'title':      'Claude Cowork × 第三方 API／本地 LLM',
        'shortTitle': '🔶 Claude Cowork 3P',
        'parent':     'ai-cli-group',
        'isGroup':    False,
    },
